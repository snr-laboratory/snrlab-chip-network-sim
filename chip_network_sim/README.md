...
- `build/chip_larpix` (`larpix_v3b_rtl/src`, primary LArPix digital-core cosim target)
- `build/chip_larpix_v2` (`larpix_v3b_rtl_v2/src`, alternate `v2` LArPix RTL target)
- `build/chip_larpix_v3c` (`larpix_v3c/src`, LArPix v3c digital-core cosim target)
- `build/chip_larpix_v3c2` (`larpix_v3c2/src`, LArPix v3c2 digital-core cosim target)
- `build/chip_larpix_msg_rtl` (`msg_rtl/src`, copied v3c2 baseline for message-RTL prototyping)
