...
# and simultaneous full-chip charge injection on four runtimes.
#
# This probe:
...
work_dir="$build_dir/larpix_6x6_msg_preenabled_multicharge_probe"
init_json="$work_dir/init_6x6_msg_preenabled_multicharge_probe_preconfigured.json"
stimulus_json="$work_dir/stimulus_6x6_msg_preenabled_multicharge_probe.json"
log_file="$work_dir/run.log"
trace_jsonl="$work_dir/trace.jsonl"
rx_debug_csv="$work_dir/chip0_rx_debug.csv"
summary_json="$work_dir/msg_preenabled_multicharge_probe_summary.json"
run_metrics_json="$work_dir/run_metrics.json"
playback_json="$work_dir/live_event_6x6_msg_preenabled_multicharge_probe.json"
ticks="${TICKS:-2400}"
...
pathlib.Path(sys.argv[1]).write_text(
    "// 6x6 msg_rtl pre-enabled multicharge probe stimulus\n"
