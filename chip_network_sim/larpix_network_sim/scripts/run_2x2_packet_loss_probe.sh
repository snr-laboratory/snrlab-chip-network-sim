...
work_dir="$build_dir/larpix_2x2_packet_loss_probe"
...
allowed = {'orchestrator_larpix', os.environ.get('CHIP_BIN_NAME', 'chip_larpix'), 'fpga_larpix', 'trace_collector_larpix'}
