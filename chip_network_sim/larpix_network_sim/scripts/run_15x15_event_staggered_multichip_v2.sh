...
work_dir="$build_dir/larpix_15x15_event_staggered_multichip_v2"
init_json="$work_dir/init_15x15_event_staggered_multichip_v2_preconfigured.json"
stimulus_json="$work_dir/stimulus_15x15_event_staggered_multichip_v2.json"
log_file="$work_dir/run.log"
trace_jsonl="$work_dir/trace.jsonl"
playback_json="$work_dir/live_event_15x15_staggered_multichip_v2.json"
...
cmake --build "$build_dir" --target fpga_larpix trace_collector_larpix orchestrator_larpix chip_larpix_v2_build -j
...
print(base_tick, last_tick, last_tick + 11600)
PYT
)"
...
cmd = [
    ...
    '-base_uri', base_uri,
    '-source_y', '0',
    '-chip_bin', str(build_dir / 'chip_larpix_v2'),
...
allowed = {'orchestrator_larpix', 'chip_larpix_v2', 'fpga_larpix', 'trace_collector_larpix'}
...
print('visualizer_url_hint=http://localhost:8000/larpix_network_sim/visualizers/packet_transmission/?playback=/build/larpix_15x15_event_staggered_multichip_v2/live_event_15x15_staggered_multichip_v2.json')
PY2
