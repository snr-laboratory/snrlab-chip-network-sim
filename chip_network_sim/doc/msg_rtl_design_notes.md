...
`http://localhost:8000/sim_core/visualizers/packet_transmission/index.html?playback=../../../build/larpix_3x3_msg_center_charge_probe/live_event_3x3_msg_center_charge_probe.json&v=5`
...
- `rtl/msg_rtl/src/larpix_constants.sv`
- `rtl/msg_rtl/src/uart_rx.sv`
- `rtl/msg_rtl/src/uart_tx.sv`
- `rtl/msg_rtl/src/comms_ctrl.sv`
- `rtl/msg_rtl/src/msg_logic.sv`
- `rtl/msg_rtl/src/hydra_ctrl.sv`
- `rtl/msg_rtl/src/external_interface.sv`
- `rtl/msg_rtl/src/digital_core.sv`

Additional likely new file:

- `rtl/msg_rtl/src/msg_generator.sv`
