...
class CosimBackend {
  ...
  private:
    ...
    void sample_rx_debug(larpixsim_backend_tick_outputs_t* out) {
        ...
        out->msg_generated_valid = 0u;
        out->msg_fifo_write_n = 1u;
        out->msg_fifo_empty = 1u;
        out->msg_fifo_read_n = 1u;
        out->msg_fifo_counter_debug = 0u;
        out->msg_fifo_data_in = 0u;
        out->msg_fifo_data_out = 0u;
