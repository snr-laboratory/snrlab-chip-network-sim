...
scenario_name="larpix_15x15_event_staggered_multichip_source_8_6"
...
print(f'visualizer_url_hint=http://localhost:8000/sim_core/visualizers/packet_transmission/?playback=/build/{pathlib.Path(playback_json).parent.name}/live_event_15x15_staggered_multichip.json')
PY2
