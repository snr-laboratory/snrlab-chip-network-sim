...
def main() -> int:
    ...
    parser.add_argument('--constants', default='rtl/v3b/src/larpix_constants.sv')
    parser.add_argument('--assign', default='rtl/v3b/src/config_regfile_assign.sv')
    parser.add_argument('--out', default='sim_core/config/startup_1chip_full_reg_readback.json')
