...
Files under [mos_cots_opamp_sim](./mos_cots_opamp_sim/) simulate a MOS (in an ASIC, wire-bonded out) plus COTS OpAmp formed Q-Pix front-end.  The procedure and results are detailed in [arXiv:2311.09568](https://arxiv.org/abs/2311.09568).
